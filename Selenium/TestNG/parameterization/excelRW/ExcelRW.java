...
/*	
	  public static void main(String[] args) throws IOException{ 
		  ExcelRW ereader = new ExcelRW("s:/1.xlsx");
		  System.out.println(ereader.getCellData("Sheet1", 0, 0));
		  System.out.println(ereader.getCellData("Sheet1", 1, 1));
		  System.out.println(ereader.getRowCount("Sheet1"));
		  System.out.println(ereader.getColsCount("Sheet1"));
		  //ereader.setCellData("Sheet2", "value", 11, 11); 
		  }
*/
}
