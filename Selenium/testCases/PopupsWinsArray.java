...
public class PopupsWinsArray {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//create chrome driver without warnings
	...
	//1. get all open windows handles-Set<String>-only unique values
		...
		A = driver.getWindowHandles().toArray();//now there are 3 windows
		driver.switchTo().window((String) A[2]);//window 3
		System.out.println(driver.getTitle());
